<template>
    <article class="my-5 w-10/12 mx-auto">
        <section class="flex w-full mb-8 mt-4">
            <h1 class="text-3xl text-center mx-auto">Nieuws</h1>
        </section>
        <section>
            <section v-if="pending">loading</section>
            <section v-if="data?.data">
                <section
                    class="mx-auto w-full bg-slate-50 bg-opacity-70 border-white border-2  rounded-lg p-4 flex "
                ...
                >
                    <img
                        ...
                        :src="getThumbnailFromMedia(blog.attributes.thumbnail)"
                        :alt="blog.attributes.thumbnail.data.attributes.caption"
                    />
                    <div class="mx-6 flex flex-col">
                        <NuxtLink :to="`/news/${blog.attributes.friendlyUrl}`" class="hover:text-green-600">
